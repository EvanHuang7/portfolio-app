  ...
  const experiences = [
    {
      ...
      period: "2020 - 2024",
      description:
        "Developing and maintaining enterprise-scale web applications and services that empower local businesses. Working with modern technologies to build scalable solutions and enhance user experiences.",
      achievements: [
